...
public class ObjectDragBoc : ObjectDragParent
{
    Canvas canvas;
    [SerializeField]
    ...
    public void UpdateBook()
    {
        ...
        else
        {
            ...
            //  GameController.Instance.CurrentObject().PlaySoundMaskCurl(true);
        }
    }
    bool playSound;
    /// <summary>
        ...
        else
        {
            if (DataParamManager.state == DataParamManager.STATEGAMEPLAY.PLAY)
            {
                ...
                Tween.ValueTo(gameObject, f, ebr * 0.98f, 0.3f, TweenUpdate, () =>
                {
                    ...
                    Debug.LogError("========== tween foward l t r : " + currentPaper);
    ...
    public void TweenBack()
    {
        if (mode == FlipMode.RightToLeft)
        {
            ...
            Tween.ValueTo(gameObject, f, ebr * 0.98f, 0.3f, TweenUpdate, () =>
            {
                ...
                UpdatePages();
                playSound = false;
                MusicManager.instance.PlaySoundLevelOneShot(false, -1);
            });
        }
        else
        {
